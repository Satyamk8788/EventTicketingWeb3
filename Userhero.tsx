...
import Icon  from '../utils/cocktail-party-concept-illustration/7324125.jpg'

const Hero: React.FC = () => {
  return (
    <main className="mt-5lg:w-2/3 w-full mx-auto relative shadow-md px-5 py-7 bg-white mt-20">
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="sm:text-center lg:text-left">
            <h1 className="text-4xl tracking-tight font-bold text-gray-900 sm:text-5xl sm:tracking-tight md:text-6xl md:tracking-tight">
              ...
              <br />
              <span className="block text-[#f02e65] xl:inline"> Web3 Marketplace</span>
            </h1>
            ...
            <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
              ...
              <button
                className="bg-[#f02e65] p-2 rounded-full py-3 px-4
                text-white mx-4 hover:bg-transparent border hover:text-[#f02e65]
                hover:border-[#f02e65] duration-300 transition-all"
              >
                Explore Marketplace
              </button>
            </div>
