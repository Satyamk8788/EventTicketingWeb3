...
const BuyTicket: React.FC<{ event: EventStruct }> = ({ event }) => {
  ...
  return (
    ...
    >
      <div className="bg-white text-black shadow-md shadow-[#f02e65]  rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
        <div className="flex flex-col">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col justify-center items-start my-5">
            ...
            <button
              type="submit"
              className="bg-[#f02e65]  p-2 rounded-full py-3 px-10
            text-white hover:bg-transparent hover:text-[#f02e65] border hover:border-[#f02e65] 
            hover:[#f02e65]  duration-300 transition-all"
            >
              Buy Now
            </button>
          </form>
